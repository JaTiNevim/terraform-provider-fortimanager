...
func flattenPackagesGlobalFooterPolicyCgnSwEifCtrl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicyEifCheck(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenPackagesGlobalFooterPolicyEifLearn(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicyHttpsSubCategory(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicyImplicitProxyDetection(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicyInternetServiceFortiguard(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyInternetServiceSrcFortiguard(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyInternetService6Fortiguard(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyInternetService6SrcFortiguard(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyPortPreserve(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicyRadiusIpAuthBypass(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesGlobalFooterPolicySamlServer(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyScim(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenPackagesGlobalFooterPolicyScimGroups(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenPackagesGlobalFooterPolicyScimUsers(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyServiceConnector(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyTelemetryProfile(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyUrlRisk(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyZtnaProxy(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func refreshObjectPackagesGlobalFooterPolicy(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("casb_profile", flattenPackagesGlobalFooterPolicyCasbProfile(o["casb-profile"], d, "casb_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["casb-profile"], "PackagesGlobalFooterPolicy-CasbProfile"); ok {
	...
	if err = d.Set("cgn_sw_eif_ctrl", flattenPackagesGlobalFooterPolicyCgnSwEifCtrl(o["cgn-sw-eif-ctrl"], d, "cgn_sw_eif_ctrl")); err != nil {
		if vv, ok := fortiAPIPatch(o["cgn-sw-eif-ctrl"], "PackagesGlobalFooterPolicy-CgnSwEifCtrl"); ok {
	...
	if err = d.Set("eif_check", flattenPackagesGlobalFooterPolicyEifCheck(o["eif-check"], d, "eif_check")); err != nil {
		if vv, ok := fortiAPIPatch(o["eif-check"], "PackagesGlobalFooterPolicy-EifCheck"); ok {
	...
	if err = d.Set("eif_learn", flattenPackagesGlobalFooterPolicyEifLearn(o["eif-learn"], d, "eif_learn")); err != nil {
		if vv, ok := fortiAPIPatch(o["eif-learn"], "PackagesGlobalFooterPolicy-EifLearn"); ok {
	...
	if err = d.Set("extended_log", flattenPackagesGlobalFooterPolicyExtendedLog(o["extended-log"], d, "extended_log")); err != nil {
		if vv, ok := fortiAPIPatch(o["extended-log"], "PackagesGlobalFooterPolicy-ExtendedLog"); ok {
	...
	if err = d.Set("https_sub_category", flattenPackagesGlobalFooterPolicyHttpsSubCategory(o["https-sub-category"], d, "https_sub_category")); err != nil {
		if vv, ok := fortiAPIPatch(o["https-sub-category"], "PackagesGlobalFooterPolicy-HttpsSubCategory"); ok {
	...
	if err = d.Set("implicit_proxy_detection", flattenPackagesGlobalFooterPolicyImplicitProxyDetection(o["implicit-proxy-detection"], d, "implicit_proxy_detection")); err != nil {
		if vv, ok := fortiAPIPatch(o["implicit-proxy-detection"], "PackagesGlobalFooterPolicy-ImplicitProxyDetection"); ok {
	...
	if err = d.Set("internet_service_fortiguard", flattenPackagesGlobalFooterPolicyInternetServiceFortiguard(o["internet-service-fortiguard"], d, "internet_service_fortiguard")); err != nil {
		if vv, ok := fortiAPIPatch(o["internet-service-fortiguard"], "PackagesGlobalFooterPolicy-InternetServiceFortiguard"); ok {
	...
	if err = d.Set("internet_service_src_fortiguard", flattenPackagesGlobalFooterPolicyInternetServiceSrcFortiguard(o["internet-service-src-fortiguard"], d, "internet_service_src_fortiguard")); err != nil {
		if vv, ok := fortiAPIPatch(o["internet-service-src-fortiguard"], "PackagesGlobalFooterPolicy-InternetServiceSrcFortiguard"); ok {
	...
	if err = d.Set("internet_service6_fortiguard", flattenPackagesGlobalFooterPolicyInternetService6Fortiguard(o["internet-service6-fortiguard"], d, "internet_service6_fortiguard")); err != nil {
		if vv, ok := fortiAPIPatch(o["internet-service6-fortiguard"], "PackagesGlobalFooterPolicy-InternetService6Fortiguard"); ok {
	...
	if err = d.Set("internet_service6_src_fortiguard", flattenPackagesGlobalFooterPolicyInternetService6SrcFortiguard(o["internet-service6-src-fortiguard"], d, "internet_service6_src_fortiguard")); err != nil {
		if vv, ok := fortiAPIPatch(o["internet-service6-src-fortiguard"], "PackagesGlobalFooterPolicy-InternetService6SrcFortiguard"); ok {
	...
	if err = d.Set("port_preserve", flattenPackagesGlobalFooterPolicyPortPreserve(o["port-preserve"], d, "port_preserve")); err != nil {
		if vv, ok := fortiAPIPatch(o["port-preserve"], "PackagesGlobalFooterPolicy-PortPreserve"); ok {
	...
	if err = d.Set("radius_ip_auth_bypass", flattenPackagesGlobalFooterPolicyRadiusIpAuthBypass(o["radius-ip-auth-bypass"], d, "radius_ip_auth_bypass")); err != nil {
		if vv, ok := fortiAPIPatch(o["radius-ip-auth-bypass"], "PackagesGlobalFooterPolicy-RadiusIpAuthBypass"); ok {
	...
	if err = d.Set("saml_server", flattenPackagesGlobalFooterPolicySamlServer(o["saml-server"], d, "saml_server")); err != nil {
		if vv, ok := fortiAPIPatch(o["saml-server"], "PackagesGlobalFooterPolicy-SamlServer"); ok {
	...
	if err = d.Set("scim", flattenPackagesGlobalFooterPolicyScim(o["scim"], d, "scim")); err != nil {
		if vv, ok := fortiAPIPatch(o["scim"], "PackagesGlobalFooterPolicy-Scim"); ok {
	...
	if err = d.Set("scim_groups", flattenPackagesGlobalFooterPolicyScimGroups(o["scim-groups"], d, "scim_groups")); err != nil {
		if vv, ok := fortiAPIPatch(o["scim-groups"], "PackagesGlobalFooterPolicy-ScimGroups"); ok {
	...
	if err = d.Set("scim_users", flattenPackagesGlobalFooterPolicyScimUsers(o["scim-users"], d, "scim_users")); err != nil {
		if vv, ok := fortiAPIPatch(o["scim-users"], "PackagesGlobalFooterPolicy-ScimUsers"); ok {
	...
	if err = d.Set("service_connector", flattenPackagesGlobalFooterPolicyServiceConnector(o["service-connector"], d, "service_connector")); err != nil {
		if vv, ok := fortiAPIPatch(o["service-connector"], "PackagesGlobalFooterPolicy-ServiceConnector"); ok {
	...
	if err = d.Set("telemetry_profile", flattenPackagesGlobalFooterPolicyTelemetryProfile(o["telemetry-profile"], d, "telemetry_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["telemetry-profile"], "PackagesGlobalFooterPolicy-TelemetryProfile"); ok {
	...
	if err = d.Set("url_risk", flattenPackagesGlobalFooterPolicyUrlRisk(o["url-risk"], d, "url_risk")); err != nil {
		if vv, ok := fortiAPIPatch(o["url-risk"], "PackagesGlobalFooterPolicy-UrlRisk"); ok {
	...
	if err = d.Set("virtual_patch_profile", flattenPackagesGlobalFooterPolicyVirtualPatchProfile(o["virtual-patch-profile"], d, "virtual_patch_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["virtual-patch-profile"], "PackagesGlobalFooterPolicy-VirtualPatchProfile"); ok {
	...
	if err = d.Set("ztna_proxy", flattenPackagesGlobalFooterPolicyZtnaProxy(o["ztna-proxy"], d, "ztna_proxy")); err != nil {
		if vv, ok := fortiAPIPatch(o["ztna-proxy"], "PackagesGlobalFooterPolicy-ZtnaProxy"); ok {
...
func expandPackagesGlobalFooterPolicyCgnSwEifCtrl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicyEifCheck(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandPackagesGlobalFooterPolicyEifLearn(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicyHttpsSubCategory(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicyImplicitProxyDetection(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicyInternetServiceFortiguard(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyInternetServiceSrcFortiguard(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyInternetService6Fortiguard(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyInternetService6SrcFortiguard(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyPortPreserve(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicyRadiusIpAuthBypass(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesGlobalFooterPolicySamlServer(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyScim(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandPackagesGlobalFooterPolicyScimGroups(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandPackagesGlobalFooterPolicyScimUsers(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyServiceConnector(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyTelemetryProfile(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyUrlRisk(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyZtnaProxy(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func getObjectPackagesGlobalFooterPolicy(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("casb_profile"); ok || d.HasChange("casb_profile") {
		t, err := expandPackagesGlobalFooterPolicyCasbProfile(d, v, "casb_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["casb-profile"] = t
	...
	if v, ok := d.GetOk("cgn_sw_eif_ctrl"); ok || d.HasChange("cgn_sw_eif_ctrl") {
		t, err := expandPackagesGlobalFooterPolicyCgnSwEifCtrl(d, v, "cgn_sw_eif_ctrl")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("eif_check"); ok || d.HasChange("eif_check") {
		t, err := expandPackagesGlobalFooterPolicyEifCheck(d, v, "eif_check")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["eif-check"] = t
	...
	if v, ok := d.GetOk("eif_learn"); ok || d.HasChange("eif_learn") {
		t, err := expandPackagesGlobalFooterPolicyEifLearn(d, v, "eif_learn")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["eif-learn"] = t
	...
	if v, ok := d.GetOk("extended_log"); ok || d.HasChange("extended_log") {
		t, err := expandPackagesGlobalFooterPolicyExtendedLog(d, v, "extended_log")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["extended-log"] = t
	...
	if v, ok := d.GetOk("https_sub_category"); ok || d.HasChange("https_sub_category") {
		t, err := expandPackagesGlobalFooterPolicyHttpsSubCategory(d, v, "https_sub_category")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("implicit_proxy_detection"); ok || d.HasChange("implicit_proxy_detection") {
		t, err := expandPackagesGlobalFooterPolicyImplicitProxyDetection(d, v, "implicit_proxy_detection")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("internet_service_fortiguard"); ok || d.HasChange("internet_service_fortiguard") {
		t, err := expandPackagesGlobalFooterPolicyInternetServiceFortiguard(d, v, "internet_service_fortiguard")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("internet_service_src_fortiguard"); ok || d.HasChange("internet_service_src_fortiguard") {
		t, err := expandPackagesGlobalFooterPolicyInternetServiceSrcFortiguard(d, v, "internet_service_src_fortiguard")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("internet_service6_fortiguard"); ok || d.HasChange("internet_service6_fortiguard") {
		t, err := expandPackagesGlobalFooterPolicyInternetService6Fortiguard(d, v, "internet_service6_fortiguard")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("internet_service6_src_fortiguard"); ok || d.HasChange("internet_service6_src_fortiguard") {
		t, err := expandPackagesGlobalFooterPolicyInternetService6SrcFortiguard(d, v, "internet_service6_src_fortiguard")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("port_preserve"); ok || d.HasChange("port_preserve") {
		t, err := expandPackagesGlobalFooterPolicyPortPreserve(d, v, "port_preserve")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["port-preserve"] = t
	...
	if v, ok := d.GetOk("radius_ip_auth_bypass"); ok || d.HasChange("radius_ip_auth_bypass") {
		t, err := expandPackagesGlobalFooterPolicyRadiusIpAuthBypass(d, v, "radius_ip_auth_bypass")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("saml_server"); ok || d.HasChange("saml_server") {
		t, err := expandPackagesGlobalFooterPolicySamlServer(d, v, "saml_server")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["saml-server"] = t
	...
	if v, ok := d.GetOk("scim"); ok || d.HasChange("scim") {
		t, err := expandPackagesGlobalFooterPolicyScim(d, v, "scim")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["scim"] = t
	...
	if v, ok := d.GetOk("scim_groups"); ok || d.HasChange("scim_groups") {
		t, err := expandPackagesGlobalFooterPolicyScimGroups(d, v, "scim_groups")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["scim-groups"] = t
	...
	if v, ok := d.GetOk("scim_users"); ok || d.HasChange("scim_users") {
		t, err := expandPackagesGlobalFooterPolicyScimUsers(d, v, "scim_users")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["scim-users"] = t
	...
	if v, ok := d.GetOk("service_connector"); ok || d.HasChange("service_connector") {
		t, err := expandPackagesGlobalFooterPolicyServiceConnector(d, v, "service_connector")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("telemetry_profile"); ok || d.HasChange("telemetry_profile") {
		t, err := expandPackagesGlobalFooterPolicyTelemetryProfile(d, v, "telemetry_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("url_risk"); ok || d.HasChange("url_risk") {
		t, err := expandPackagesGlobalFooterPolicyUrlRisk(d, v, "url_risk")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["url-risk"] = t
	...
	if v, ok := d.GetOk("virtual_patch_profile"); ok || d.HasChange("virtual_patch_profile") {
		t, err := expandPackagesGlobalFooterPolicyVirtualPatchProfile(d, v, "virtual_patch_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ztna_proxy"); ok || d.HasChange("ztna_proxy") {
		t, err := expandPackagesGlobalFooterPolicyZtnaProxy(d, v, "ztna_proxy")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ztna-proxy"] = t
