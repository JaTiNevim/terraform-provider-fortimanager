...
func resourceObjectFirewallGtp() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"ie_allow_list_v0v1": &schema.Schema{
				Type:     schema.TypeString,
				Optional: true,
			},
			"ie_allow_list_v2": &schema.Schema{
				Type:     schema.TypeString,
				Optional: true,
			},
			...
			"rat_timeout_profile": &schema.Schema{
				Type:     schema.TypeString,
				Optional: true,
			},
...
func resourceObjectFirewallGtpCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateObjectFirewallGtp(obj, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallGtpUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallGtp(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallGtpDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallGtp(mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallGtpRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadObjectFirewallGtp(mkey, paradict)
	if err != nil {
...
func flattenObjectFirewallGtpPolicy(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "imsi"
		if _, ok := i["imsi"]; ok {
			v := flattenObjectFirewallGtpPolicyImsi(i["imsi"], d, pre_append)
			tmp["imsi"] = fortiAPISubPartPatch(v, "ObjectFirewallGtp-Policy-Imsi")
		}
		...
		if _, ok := i["msisdn"]; ok {
			v := flattenObjectFirewallGtpPolicyMsisdn(i["msisdn"], d, pre_append)
			tmp["msisdn"] = fortiAPISubPartPatch(v, "ObjectFirewallGtp-Policy-Msisdn")
		}
...
func flattenObjectFirewallGtpPolicyImsi(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectFirewallGtpPolicyMsisdn(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectFirewallGtp(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("ie_allow_list_v0v1", flattenObjectFirewallGtpIeAllowListV0V1(o["ie-allow-list-v0v1"], d, "ie_allow_list_v0v1")); err != nil {
		if vv, ok := fortiAPIPatch(o["ie-allow-list-v0v1"], "ObjectFirewallGtp-IeAllowListV0V1"); ok {
			if err = d.Set("ie_allow_list_v0v1", vv); err != nil {
				return fmt.Errorf("Error reading ie_allow_list_v0v1: %v", err)
			}
		} else {
			return fmt.Errorf("Error reading ie_allow_list_v0v1: %v", err)
		}
	...
	if err = d.Set("ie_allow_list_v2", flattenObjectFirewallGtpIeAllowListV2(o["ie-allow-list-v2"], d, "ie_allow_list_v2")); err != nil {
		if vv, ok := fortiAPIPatch(o["ie-allow-list-v2"], "ObjectFirewallGtp-IeAllowListV2"); ok {
			if err = d.Set("ie_allow_list_v2", vv); err != nil {
				return fmt.Errorf("Error reading ie_allow_list_v2: %v", err)
			}
		} else {
			return fmt.Errorf("Error reading ie_allow_list_v2: %v", err)
		}
	...
	if err = d.Set("rat_timeout_profile", flattenObjectFirewallGtpRatTimeoutProfile(o["rat-timeout-profile"], d, "rat_timeout_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["rat-timeout-profile"], "ObjectFirewallGtp-RatTimeoutProfile"); ok {
			if err = d.Set("rat_timeout_profile", vv); err != nil {
				return fmt.Errorf("Error reading rat_timeout_profile: %v", err)
			}
		} else {
			return fmt.Errorf("Error reading rat_timeout_profile: %v", err)
		}
...
func expandObjectFirewallGtpPolicy(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "imsi"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["imsi"], _ = expandObjectFirewallGtpPolicyImsi(d, i["imsi"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "msisdn"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["msisdn"], _ = expandObjectFirewallGtpPolicyMsisdn(d, i["msisdn"], pre_append)
		}
...
func expandObjectFirewallGtpPolicyImsi(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectFirewallGtpPolicyMsisdn(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectFirewallGtp(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("addr_notify"); ok || d.HasChange("addr_notify") {
	...
	if v, ok := d.GetOk("apn_filter"); ok || d.HasChange("apn_filter") {
	...
	if v, ok := d.GetOk("authorized_ggsns"); ok || d.HasChange("authorized_ggsns") {
	...
	if v, ok := d.GetOk("authorized_ggsns6"); ok || d.HasChange("authorized_ggsns6") {
	...
	if v, ok := d.GetOk("authorized_sgsns"); ok || d.HasChange("authorized_sgsns") {
	...
	if v, ok := d.GetOk("authorized_sgsns6"); ok || d.HasChange("authorized_sgsns6") {
	...
	if v, ok := d.GetOk("context_id"); ok || d.HasChange("context_id") {
	...
	if v, ok := d.GetOk("control_plane_message_rate_limit"); ok || d.HasChange("control_plane_message_rate_limit") {
	...
	if v, ok := d.GetOk("default_apn_action"); ok || d.HasChange("default_apn_action") {
	...
	if v, ok := d.GetOk("default_imsi_action"); ok || d.HasChange("default_imsi_action") {
	...
	if v, ok := d.GetOk("default_ip_action"); ok || d.HasChange("default_ip_action") {
	...
	if v, ok := d.GetOk("default_noip_action"); ok || d.HasChange("default_noip_action") {
	...
	if v, ok := d.GetOk("default_policy_action"); ok || d.HasChange("default_policy_action") {
	...
	if v, ok := d.GetOk("echo_request_interval"); ok || d.HasChange("echo_request_interval") {
	...
	if v, ok := d.GetOk("extension_log"); ok || d.HasChange("extension_log") {
	...
	if v, ok := d.GetOk("global_tunnel_limit"); ok || d.HasChange("global_tunnel_limit") {
	...
	if v, ok := d.GetOk("gtp_in_gtp"); ok || d.HasChange("gtp_in_gtp") {
	...
	if v, ok := d.GetOk("gtpu_denied_log"); ok || d.HasChange("gtpu_denied_log") {
	...
	if v, ok := d.GetOk("gtpu_forwarded_log"); ok || d.HasChange("gtpu_forwarded_log") {
	...
	if v, ok := d.GetOk("gtpu_log_freq"); ok || d.HasChange("gtpu_log_freq") {
	...
	if v, ok := d.GetOk("half_close_timeout"); ok || d.HasChange("half_close_timeout") {
	...
	if v, ok := d.GetOk("half_open_timeout"); ok || d.HasChange("half_open_timeout") {
	...
	if v, ok := d.GetOk("handover_group"); ok || d.HasChange("handover_group") {
	...
	if v, ok := d.GetOk("handover_group6"); ok || d.HasChange("handover_group6") {
	...
	if v, ok := d.GetOk("ie_allow_list_v0v1"); ok || d.HasChange("ie_allow_list_v0v1") {
		t, err := expandObjectFirewallGtpIeAllowListV0V1(d, v, "ie_allow_list_v0v1")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ie-allow-list-v0v1"] = t
		}
	}

	if v, ok := d.GetOk("ie_allow_list_v2"); ok || d.HasChange("ie_allow_list_v2") {
		t, err := expandObjectFirewallGtpIeAllowListV2(d, v, "ie_allow_list_v2")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ie-allow-list-v2"] = t
		}
	}

	if v, ok := d.GetOk("ie_remove_policy"); ok || d.HasChange("ie_remove_policy") {
	...
	if v, ok := d.GetOk("ie_remover"); ok || d.HasChange("ie_remover") {
	...
	if v, ok := d.GetOk("ie_validation"); ok || d.HasChange("ie_validation") {
	...
	if v, ok := d.GetOk("ie_white_list_v0v1"); ok || d.HasChange("ie_white_list_v0v1") {
	...
	if v, ok := d.GetOk("ie_white_list_v2"); ok || d.HasChange("ie_white_list_v2") {
	...
	if v, ok := d.GetOk("imsi_filter"); ok || d.HasChange("imsi_filter") {
	...
	if v, ok := d.GetOk("interface_notify"); ok || d.HasChange("interface_notify") {
	...
	if v, ok := d.GetOk("invalid_sgsns_to_log"); ok || d.HasChange("invalid_sgsns_to_log") {
	...
	if v, ok := d.GetOk("invalid_sgsns6_to_log"); ok || d.HasChange("invalid_sgsns6_to_log") {
	...
	if v, ok := d.GetOk("ip_filter"); ok || d.HasChange("ip_filter") {
	...
	if v, ok := d.GetOk("ip_policy"); ok || d.HasChange("ip_policy") {
	...
	if v, ok := d.GetOk("log_gtpu_limit"); ok || d.HasChange("log_gtpu_limit") {
	...
	if v, ok := d.GetOk("log_imsi_prefix"); ok || d.HasChange("log_imsi_prefix") {
	...
	if v, ok := d.GetOk("log_msisdn_prefix"); ok || d.HasChange("log_msisdn_prefix") {
	...
	if v, ok := d.GetOk("message_filter_v0v1"); ok || d.HasChange("message_filter_v0v1") {
	...
	if v, ok := d.GetOk("message_filter_v2"); ok || d.HasChange("message_filter_v2") {
	...
	if v, ok := d.GetOk("message_rate_limit"); ok || d.HasChange("message_rate_limit") {
	...
	if v, ok := d.GetOk("message_rate_limit_v0"); ok || d.HasChange("message_rate_limit_v0") {
	...
	if v, ok := d.GetOk("message_rate_limit_v1"); ok || d.HasChange("message_rate_limit_v1") {
	...
	if v, ok := d.GetOk("message_rate_limit_v2"); ok || d.HasChange("message_rate_limit_v2") {
	...
	if v, ok := d.GetOk("miss_must_ie"); ok || d.HasChange("miss_must_ie") {
	...
	if v, ok := d.GetOk("noip_filter"); ok || d.HasChange("noip_filter") {
	...
	if v, ok := d.GetOk("noip_policy"); ok || d.HasChange("noip_policy") {
	...
	if v, ok := d.GetOk("out_of_state_ie"); ok || d.HasChange("out_of_state_ie") {
	...
	if v, ok := d.GetOk("out_of_state_message"); ok || d.HasChange("out_of_state_message") {
	...
	if v, ok := d.GetOk("per_apn_shaper"); ok || d.HasChange("per_apn_shaper") {
	...
	if v, ok := d.GetOk("policy_filter"); ok || d.HasChange("policy_filter") {
	...
	if v, ok := d.GetOk("policy_v2"); ok || d.HasChange("policy_v2") {
	...
	if v, ok := d.GetOk("port_notify"); ok || d.HasChange("port_notify") {
	...
	if v, ok := d.GetOk("rat_timeout_profile"); ok || d.HasChange("rat_timeout_profile") {
		t, err := expandObjectFirewallGtpRatTimeoutProfile(d, v, "rat_timeout_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["rat-timeout-profile"] = t
		}
	}

	if v, ok := d.GetOk("rate_limit_mode"); ok || d.HasChange("rate_limit_mode") {
	...
	if v, ok := d.GetOk("rate_limited_log"); ok || d.HasChange("rate_limited_log") {
	...
	if v, ok := d.GetOk("rate_sampling_interval"); ok || d.HasChange("rate_sampling_interval") {
	...
	if v, ok := d.GetOk("remove_if_echo_expires"); ok || d.HasChange("remove_if_echo_expires") {
	...
	if v, ok := d.GetOk("remove_if_recovery_differ"); ok || d.HasChange("remove_if_recovery_differ") {
	...
	if v, ok := d.GetOk("reserved_ie"); ok || d.HasChange("reserved_ie") {
	...
	if v, ok := d.GetOk("send_delete_when_timeout"); ok || d.HasChange("send_delete_when_timeout") {
	...
	if v, ok := d.GetOk("send_delete_when_timeout_v2"); ok || d.HasChange("send_delete_when_timeout_v2") {
	...
	if v, ok := d.GetOk("spoof_src_addr"); ok || d.HasChange("spoof_src_addr") {
	...
	if v, ok := d.GetOk("state_invalid_log"); ok || d.HasChange("state_invalid_log") {
	...
	if v, ok := d.GetOk("sub_second_interval"); ok || d.HasChange("sub_second_interval") {
	...
	if v, ok := d.GetOk("sub_second_sampling"); ok || d.HasChange("sub_second_sampling") {
	...
	if v, ok := d.GetOk("tunnel_limit"); ok || d.HasChange("tunnel_limit") {
	...
	if v, ok := d.GetOk("tunnel_limit_log"); ok || d.HasChange("tunnel_limit_log") {
	...
	if v, ok := d.GetOk("tunnel_timeout"); ok || d.HasChange("tunnel_timeout") {
	...
	if v, ok := d.GetOk("unknown_version_action"); ok || d.HasChange("unknown_version_action") {
	...
	if v, ok := d.GetOk("user_plane_message_rate_limit"); ok || d.HasChange("user_plane_message_rate_limit") {
	...
	if v, ok := d.GetOk("warning_threshold"); ok || d.HasChange("warning_threshold") {
