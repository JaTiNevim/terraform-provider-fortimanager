...
func flattenPackagesGlobalHeaderShapingPolicyCos(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenPackagesGlobalHeaderShapingPolicyCosMask(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectPackagesGlobalHeaderShapingPolicy(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("cos", flattenPackagesGlobalHeaderShapingPolicyCos(o["cos"], d, "cos")); err != nil {
		if vv, ok := fortiAPIPatch(o["cos"], "PackagesGlobalHeaderShapingPolicy-Cos"); ok {
	...
	if err = d.Set("cos_mask", flattenPackagesGlobalHeaderShapingPolicyCosMask(o["cos-mask"], d, "cos_mask")); err != nil {
		if vv, ok := fortiAPIPatch(o["cos-mask"], "PackagesGlobalHeaderShapingPolicy-CosMask"); ok {
	...
	if err = d.Set("traffic_type", flattenPackagesGlobalHeaderShapingPolicyTrafficType(o["traffic-type"], d, "traffic_type")); err != nil {
		if vv, ok := fortiAPIPatch(o["traffic-type"], "PackagesGlobalHeaderShapingPolicy-TrafficType"); ok {
...
func expandPackagesGlobalHeaderShapingPolicyCos(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandPackagesGlobalHeaderShapingPolicyCosMask(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectPackagesGlobalHeaderShapingPolicy(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("cos"); ok || d.HasChange("cos") {
		t, err := expandPackagesGlobalHeaderShapingPolicyCos(d, v, "cos")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["cos"] = t
	...
	if v, ok := d.GetOk("cos_mask"); ok || d.HasChange("cos_mask") {
		t, err := expandPackagesGlobalHeaderShapingPolicyCosMask(d, v, "cos_mask")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["cos-mask"] = t
	...
	if v, ok := d.GetOk("traffic_type"); ok || d.HasChange("traffic_type") {
		t, err := expandPackagesGlobalHeaderShapingPolicyTrafficType(d, v, "traffic_type")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["traffic-type"] = t
