...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_ztna_trafficforwardproxy_sslciphersuites"
description: |-
  ObjectZtna TrafficForwardProxySslCipherSuites
---

# fortimanager_object_ztna_trafficforwardproxy_sslciphersuites
ObjectZtna TrafficForwardProxySslCipherSuites

~> This resource is a sub resource for variable `ssl_cipher_suites` of resource `fortimanager_object_ztna_trafficforwardproxy`. Conflict and overwrite may occur if use both of them.
...
$ terraform import fortimanager_object_ztna_trafficforwardproxy_sslciphersuites.labelname {{priority}}
