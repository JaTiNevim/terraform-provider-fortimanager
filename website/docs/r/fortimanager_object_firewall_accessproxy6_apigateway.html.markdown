...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_firewall_accessproxy6_apigateway"
description: |-
  Set IPv4 API Gateway.
---

# fortimanager_object_firewall_accessproxy6_apigateway
Set IPv4 API Gateway.
...
```hcl
resource "fortimanager_object_firewall_accessproxy6_apigateway" "trname" {
...
$ terraform import fortimanager_object_firewall_accessproxy6_apigateway.labelname {{fosid}}
