...
func flattenObjectAntivirusProfilePop3MalwareStream2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectAntivirusProfilePop3(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("malware_stream", flattenObjectAntivirusProfilePop3MalwareStream2edl(o["malware-stream"], d, "malware_stream")); err != nil {
		if vv, ok := fortiAPIPatch(o["malware-stream"], "ObjectAntivirusProfilePop3-MalwareStream"); ok {
...
func expandObjectAntivirusProfilePop3MalwareStream2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectAntivirusProfilePop3(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("malware_stream"); ok || d.HasChange("malware_stream") {
		t, err := expandObjectAntivirusProfilePop3MalwareStream2edl(d, v, "malware_stream")
		if err != nil {
			return &obj, err
		} else if t != nil {
