...
func resourceObjectAntivirusProfileImapUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectAntivirusProfileImap(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectAntivirusProfileImapDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectAntivirusProfileImap(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectAntivirusProfileImapMalwareStream2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectAntivirusProfileImap(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("malware_stream", flattenObjectAntivirusProfileImapMalwareStream2edl(o["malware-stream"], d, "malware_stream")); err != nil {
		if vv, ok := fortiAPIPatch(o["malware-stream"], "ObjectAntivirusProfileImap-MalwareStream"); ok {
...
func expandObjectAntivirusProfileImapMalwareStream2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectAntivirusProfileImap(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("malware_stream"); ok || d.HasChange("malware_stream") {
		t, err := expandObjectAntivirusProfileImapMalwareStream2edl(d, v, "malware_stream")
		if err != nil {
			return &obj, err
		} else if t != nil {
