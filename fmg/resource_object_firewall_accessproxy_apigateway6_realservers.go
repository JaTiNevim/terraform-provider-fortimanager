...
func resourceObjectFirewallAccessProxyApiGateway6RealserversCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateObjectFirewallAccessProxyApiGateway6Realservers(obj, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxyApiGateway6RealserversUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallAccessProxyApiGateway6Realservers(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxyApiGateway6RealserversDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallAccessProxyApiGateway6Realservers(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectFirewallAccessProxyApiGateway6RealserversVerifyCert3rdl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectFirewallAccessProxyApiGateway6Realservers(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("verify_cert", flattenObjectFirewallAccessProxyApiGateway6RealserversVerifyCert3rdl(o["verify-cert"], d, "verify_cert")); err != nil {
		if vv, ok := fortiAPIPatch(o["verify-cert"], "ObjectFirewallAccessProxyApiGateway6Realservers-VerifyCert"); ok {
...
func expandObjectFirewallAccessProxyApiGateway6RealserversVerifyCert3rdl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectFirewallAccessProxyApiGateway6Realservers(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("verify_cert"); ok || d.HasChange("verify_cert") {
		t, err := expandObjectFirewallAccessProxyApiGateway6RealserversVerifyCert3rdl(d, v, "verify_cert")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["verify-cert"] = t
