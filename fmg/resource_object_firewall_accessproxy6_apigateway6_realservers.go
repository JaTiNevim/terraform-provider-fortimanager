...
func resourceObjectFirewallAccessProxy6ApiGateway6RealserversCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateObjectFirewallAccessProxy6ApiGateway6Realservers(obj, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxy6ApiGateway6RealserversUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallAccessProxy6ApiGateway6Realservers(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxy6ApiGateway6RealserversDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallAccessProxy6ApiGateway6Realservers(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert3rdl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectFirewallAccessProxy6ApiGateway6Realservers(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("verify_cert", flattenObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert3rdl(o["verify-cert"], d, "verify_cert")); err != nil {
		if vv, ok := fortiAPIPatch(o["verify-cert"], "ObjectFirewallAccessProxy6ApiGateway6Realservers-VerifyCert"); ok {
...
func expandObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert3rdl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectFirewallAccessProxy6ApiGateway6Realservers(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("verify_cert"); ok || d.HasChange("verify_cert") {
		t, err := expandObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert3rdl(d, v, "verify_cert")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["verify-cert"] = t
