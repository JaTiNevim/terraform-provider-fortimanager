...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_ztna_webproxy_apigateway_quic"
description: |-
  QUIC setting.
---

# fortimanager_object_ztna_webproxy_apigateway_quic
QUIC setting.

~> This resource is a sub resource for variable `quic` of resource `fortimanager_object_ztna_webproxy_apigateway`. Conflict and overwrite may occur if use both of them.
...
$ terraform import fortimanager_object_ztna_webproxy_apigateway_quic.labelname ObjectZtnaWebProxyApiGatewayQuic
