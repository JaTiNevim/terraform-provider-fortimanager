...
func resourceObjectFirewallAccessProxy6ApiGateway6Create(d *schema.ResourceData, m interface{}) error {
	...
	v, err := c.CreateObjectFirewallAccessProxy6ApiGateway6(obj, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxy6ApiGateway6Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallAccessProxy6ApiGateway6(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallAccessProxy6ApiGateway6Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallAccessProxy6ApiGateway6(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectFirewallAccessProxy6ApiGateway6Realservers2edl(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if _, ok := i["verify-cert"]; ok {
			v := flattenObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert2edl(i["verify-cert"], d, pre_append)
...
func flattenObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func expandObjectFirewallAccessProxy6ApiGateway6Realservers2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "verify_cert"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["verify-cert"], _ = expandObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert2edl(d, i["verify_cert"], pre_append)
		}
...
func expandObjectFirewallAccessProxy6ApiGateway6RealserversVerifyCert2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
