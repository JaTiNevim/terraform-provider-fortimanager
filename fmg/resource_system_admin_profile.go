...
func resourceSystemAdminProfile() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"policy_ips_attrs": &schema.Schema{
				Type:     schema.TypeString,
				Optional: true,
				Computed: true,
			},
...
func resourceSystemAdminProfileCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateSystemAdminProfile(obj, paradict, wsParams)
	if err != nil {
...
func resourceSystemAdminProfileUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAdminProfile(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceSystemAdminProfileDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSystemAdminProfile(mkey, paradict, wsParams)
	if err != nil {
...
func flattenSystemAdminProfilePolicyIpsAttrs(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectSystemAdminProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("policy_ips_attrs", flattenSystemAdminProfilePolicyIpsAttrs(o["policy-ips-attrs"], d, "policy_ips_attrs")); err != nil {
		if vv, ok := fortiAPIPatch(o["policy-ips-attrs"], "SystemAdminProfile-PolicyIpsAttrs"); ok {
			if err = d.Set("policy_ips_attrs", vv); err != nil {
				return fmt.Errorf("Error reading policy_ips_attrs: %v", err)
			}
		} else {
			return fmt.Errorf("Error reading policy_ips_attrs: %v", err)
		}
...
func expandSystemAdminProfilePolicyIpsAttrs(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemAdminProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("policy_ips_attrs"); ok || d.HasChange("policy_ips_attrs") {
		t, err := expandSystemAdminProfilePolicyIpsAttrs(d, v, "policy_ips_attrs")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["policy-ips-attrs"] = t
		}
	}
